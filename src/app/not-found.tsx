...
export default function NotFound() {
  return (
    <div className="bg-[#F7F7F5] dark:bg-[#111416] min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="max-w-md w-full text-center bg-white dark:bg-[#181C1F] border border-[#D9DCDD] dark:border-[#30363A] p-8 sm:p-10 rounded-xs shadow-xs">
        <div className="inline-flex items-center justify-center w-12 h-12 bg-[#EEF0F0] dark:bg-[#202529] border border-[#D9DCDD] dark:border-[#30363A] text-[#171A1C] dark:text-[#F1F3F4] mb-4 font-mono font-bold text-lg rounded-xs">
          404
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-[#D9DCDD]/60 dark:border-[#30363A] flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
