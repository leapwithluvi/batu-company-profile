...
export default function ErrorBoundary({
  ...
  return (
    <div className="bg-[#FFFFFF] dark:bg-[#111416] min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="max-w-md w-full text-center bg-white dark:bg-[#181C1F] border border-[#E2E8F0] dark:border-[#30363A] p-8 sm:p-10 rounded-xs shadow-xs">
        ...
        {error.digest && (
          <div className="mt-4 p-2 bg-[#F1F5F9] dark:bg-[#202529] text-[10px] font-mono text-[#6B7378] dark:text-[#A5ADB2] border border-[#E2E8F0] dark:border-[#30363A] rounded-xs">
            Kode Referensi Insiden: {error.digest}
          </div>
        )}

        <div className="mt-6 pt-6 border-t border-[#E2E8F0]/60 dark:border-[#30363A] flex flex-col sm:flex-row gap-3 justify-center">
          <button
            type="button"
            onClick={() => reset()}
            className="inline-flex items-center justify-center gap-2 bg-[#EA580C] hover:bg-[#C2410C] dark:bg-[#FB923C] dark:hover:bg-[#EA580C] text-white dark:text-[#111416] text-xs font-semibold px-4 py-2.5 transition-colors cursor-pointer rounded-xs shadow-xs"
          >
