...
export const metadata: Metadata = {
  ...
  description:
    `Hubungi dispatcher ${siteConfig.name} via WhatsApp. Cek harga batu koral, batu belah, batu split, dan estimasi ongkos kirim dump truck ke Tenggarong, Kutai Kartanegara, dan sekitarnya.`,
  keywords: [
    // Intent transaksional tinggi
    "kontak supplier batu koral tenggarong",
    "kontak supplier batu split tenggarong",
    "kontak supplier batu agregat tenggarong",
    "kontak supplier batu tronjolan tenggarong",
    ...
    "harga batu split per rit tenggarong",
    ...
    "cara pesan batu split tenggarong",
    "pemesanan batu koral kutai kartanegara",
  ],
  alternates: {
      ...
      <section className="py-14 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="bg-white dark:bg-[#181C1F] border border-[#E2E8F0] dark:border-[#30363A] p-6 sm:p-8 space-y-6 rounded-xs shadow-xs">
              <h2 className="text-lg font-bold text-[#171A1C] dark:text-[#F1F3F4] pb-3 border-b border-[#E2E8F0]/60 dark:border-[#30363A] font-mono uppercase tracking-wider">
                Kontak Langsung Operasional
              </h2>

              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-[#EA580C] dark:text-[#FB923C] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-[#EA580C] dark:text-[#FB923C] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-[#EA580C] dark:text-[#FB923C] shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-[#171A1C] dark:text-[#F1F3F4]">Telepon / WhatsApp Resmi:</strong>
                    <a
                      href={`tel:${siteConfig.whatsappNumber}`}
                      className="text-[#171A1C] dark:text-[#F1F3F4] font-mono font-semibold hover:text-[#EA580C] dark:hover:text-[#FB923C]"
                    >
                ...
                <div className="flex items-start gap-3">
                  <Mail className="w-5 h-5 text-[#EA580C] dark:text-[#FB923C] shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-[#171A1C] dark:text-[#F1F3F4]">Email Resmi:</strong>
                    <a
                      href={`mailto:${siteConfig.email}`}
                      className="text-[#171A1C] dark:text-[#F1F3F4] font-mono font-semibold hover:text-[#EA580C] dark:hover:text-[#FB923C] break-all"
                    >
                      {siteConfig.email}
                    </a>
                  </div>
              ...
              {/* Order Checklist */}
              <div className="mt-6 pt-6 border-t border-[#E2E8F0]/60 dark:border-[#30363A]">
                ...
                <ul className="space-y-2 text-xs text-[#3F4549] dark:text-[#C2C8CC]">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#EA580C] dark:text-[#FB923C] shrink-0" />
...
Terima kasih.`}
            ...
            {/* Coverage Notes */}
            <div className="bg-[#F1F5F9]/60 dark:bg-[#181C1F] border border-[#E2E8F0] dark:border-[#30363A] p-6 rounded-xs shadow-xs">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white dark:bg-[#181C1F] border border-[#E2E8F0] dark:border-[#30363A] p-6 sm:p-8 rounded-xs shadow-xs">
              <div className="flex items-center gap-2 pb-3 mb-6 border-b border-[#E2E8F0]/60 dark:border-[#30363A]">
