        ...
        <div className="p-6 sm:p-8 md:col-span-7 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-3 text-xs text-[#6B7378] dark:text-[#A5ADB2] font-mono mb-2.5">
              <span className="text-[#1F4E5F] dark:text-[#6F9AAA] font-semibold">{article.category}</span>
              <span>&bull;</span>
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-[#171A1C] dark:text-[#F1F3F4] tracking-tight group-hover:text-[#1F4E5F] dark:group-hover:text-[#6F9AAA] transition-colors">
          ...
          <div className="mt-6 pt-4 border-t border-[#D9DCDD]/60 dark:border-[#30363A] flex items-center justify-between">
    ...
    <article className="border border-[#D9DCDD] dark:border-[#30363A] bg-white dark:bg-[#181C1F] flex flex-col justify-between group hover:border-[#B8BEC0] dark:hover:border-[#41494E] transition-colors rounded-lg overflow-hidden shadow-xs">
      <div>
        ...
        <div className="p-5">
          ...
          <h3 className="text-base font-bold text-[#171A1C] dark:text-[#F1F3F4] tracking-tight leading-snug group-hover:text-[#1F4E5F] dark:group-hover:text-[#6F9AAA] transition-colors">
            <Link href={`/blog/${article.slug}`}>
              {article.title}
            </Link>
          </h3>
      ...
      <div className="p-5 pt-0 mt-3 border-t border-[#D9DCDD]/60 dark:border-[#30363A]">
        <Link
          href={`/blog/${article.slug}`}
          className="pt-3 text-xs font-semibold text-[#1F4E5F] dark:text-[#6F9AAA] hover:text-[#173B48] dark:hover:text-[#8AB2C2] inline-flex items-center justify-between w-full"
        >
