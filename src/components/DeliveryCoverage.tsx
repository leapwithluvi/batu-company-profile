        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="bg-white dark:bg-[#181C1F] border border-[#D9DCDD] dark:border-[#30363A] p-4 rounded-xs shadow-xs">
          ...
          {/* Right Column */}
          <div className="lg:col-span-6 bg-white dark:bg-[#181C1F] border border-[#D9DCDD] dark:border-[#30363A] p-6 sm:p-8 rounded-xs shadow-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
              {siteConfig.serviceAreas.map((area) => (
                <div
                  key={area}
                  className="flex items-center gap-2 p-2.5 bg-[#EEF0F0] dark:bg-[#202529] border border-[#D9DCDD] dark:border-[#30363A] text-xs font-medium text-[#171A1C] dark:text-[#F1F3F4] rounded-xs"
                >
