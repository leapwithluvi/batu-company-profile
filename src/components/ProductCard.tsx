...
export function ProductCard({
  ...
  if (variant === "editorial") {
    ...
    return (
      <article className="border border-[#D9DCDD] dark:border-[#30363A] bg-white dark:bg-[#181C1F] transition-colors hover:border-[#B8BEC0] dark:hover:border-[#41494E] rounded-xs">
        <div
        ...
        >
          ...
          >
            ...
            />
            <div className="absolute top-4 left-4 bg-[#111416]/90 text-white text-xs font-mono uppercase px-2.5 py-1 tracking-wider rounded-xs">
              {product.category}
            </div>
          </div>
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-2.5">
                ...
                <span className="text-[11px] bg-[#EEF0F0] dark:bg-[#202529] text-[#3F4549] dark:text-[#C2C8CC] border border-[#D9DCDD] dark:border-[#30363A] px-2 py-0.5 font-mono rounded-xs">
            ...
            <div className="mt-8 pt-6 border-t border-[#D9DCDD] dark:border-[#30363A] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-2.5">
                <Link
                  href={`/produk/${product.slug}`}
                  className="inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold text-[#171A1C] dark:text-[#F1F3F4] bg-[#EEF0F0] dark:bg-[#202529] hover:bg-[#E5E8E8] dark:hover:bg-[#282E33] transition-colors border border-[#D9DCDD] dark:border-[#30363A] rounded-xs"
                >
  ...
  return (
    <article className="border border-[#D9DCDD] dark:border-[#30363A] bg-white dark:bg-[#181C1F] flex flex-col justify-between transition-colors hover:border-[#B8BEC0] dark:hover:border-[#41494E] rounded-xs shadow-xs">
      <div>
